...
/**
 * @author Jerry Heuring This is the MailAddressInterface you are to implement
 *         for Project 0. You will need a class that implements this interface.
 * 
...
public interface MailAddressInterface
{
	...
	/**
	 * Get the second address line for this address (may be null or the empty string
	 * if there is none).
	 * 
	 ...
	 * 
	 * @return The name of the state or the abbreviation of the state for this
	 *         address.
	 */
	...
	/**
	 * Get the n't digit of the zip code for this address. Digit 1 is the units
	 * digit and zip codes MUST be only 5 digits for this project. If my zip code is
	 * 98765 then digit 1 = 5 digit 2 = 6 digit 3 = 7 digit 4 = 8 digit 5 = 9
	 * 
	 * @param digit which digit of the zip code to return. Digit 1 is the units
	 *              digit.
