...
public class Project0Helper {
	...
	public static void main(String[] args) {
		...
		MailAddressInterface myList[] = new Project0[100];
		Project0Helper helper = new Project0Helper();
		Scanner myscanner;
		try {
			myscanner = new Scanner(new File("eecs2500Project0Dataset1.txt") );
			try {
				for (int i= 0; i < 100; i++) {
					...
					myList[i] = new Project0(name, address1, address2, city, state, zip);
